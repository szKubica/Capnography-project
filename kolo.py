...
path = r"C:\Users\Lenovo\Kolo naukowe\Dane.csv"
...
def sample_intervals(max_value, operator, path, graph_start_row, graph_end_row):
    sample = 0
    samples_list = []
...
if __name__ == "__main__":
    ...
    print(sample_intervals(max_value, ">", path, graph_start_row, graph_end_row))
    print(sample_intervals(max_value, "<", path, graph_start_row, graph_end_row))
